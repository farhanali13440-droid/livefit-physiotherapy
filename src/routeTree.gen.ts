...
export interface FileRouteTypes{fileRoutesByFullPath:FileRoutesByFullPath;fullPaths:'/'|'/other-services'|'/about-dr-saad'|'/reviews'|'/book-assessment'|'/back-pain-physiotherapy-islamabad'|'/sciatica-physiotherapy-islamabad'|'/disc-bulge-physiotherapy-islamabad';fileRoutesByTo:FileRoutesByTo;to:FileRoutesByFullPath extends never?never: '/'|'/other-services'|'/about-dr-saad'|'/reviews'|'/book-assessment'|'/back-pain-physiotherapy-islamabad'|'/sciatica-physiotherapy-islamabad'|'/disc-bulge-physiotherapy-islamabad';id:'__root__'|keyof FileRoutesById;fileRoutesById:FileRoutesById}
...
const rootRouteChildren:RootRouteChildren={IndexRoute,OtherServicesRoute,AboutDrSaadRoute,ReviewsRoute,BookAssessmentRoute,BackPainRoute,SciaticaRoute,DiscBulgeRoute}
