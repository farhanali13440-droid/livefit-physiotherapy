...
export const SERVICES = [
  ...
  { title: "Neck & Shoulder Pain", body: "Personalized physiotherapy for neck and shoulder pain, stiffness and movement limitations.", cta: "Learn More", icon: "spine" },
  ...
  { title: "Musculoskeletal Rehabilitation", body: "Individualized assessment and rehabilitation for muscles, joints and movement-related problems.", cta: "Learn More", icon: "activity" },
...
export const FAQS = [
  ...
  { q: "Who will assess me?", a: "Your assessment is with Dr. Saad Sarfraz, Chief Physiotherapist and Spine Specialist, with a spine-focused physiotherapy approach." },
