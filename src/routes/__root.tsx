...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Expert physiotherapy in Islamabad for back pain, sciatica, disc bulge, spine problems and sports injuries. Book your assessment at LiveFit.",
      },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700&family=Instrument+Serif:ital@0;1&display=swap" },
      { rel: "icon", type: "image/png", href: "/favicon.png" },
    ],
    scripts: [
      { src: "https://www.googletagmanager.com/gtag/js?id=AW-18406446829", async: true },
      { children: `window.dataLayer = window.dataLayer || [];\nfunction gtag(){dataLayer.push(arguments);}\ngtag('js', new Date());\ngtag('config', 'AW-18406446829');` },
    ],
  }),
