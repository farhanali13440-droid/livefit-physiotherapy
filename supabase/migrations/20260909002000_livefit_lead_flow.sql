...
alter table public.leads
  ...
  add column if not exists lead_created boolean not null default true,
  add column if not exists gclid text;

alter table public.leads
  alter column contact_method set default 'Not Selected';
...
begin
  ...
  insert into public.leads (
    ...
    landing_page, referrer, gclid, lead_status, lead_created
  ) values (
